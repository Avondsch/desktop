...
myFocusColor :: String
myFocusColor  = "#c5c8c6"   -- Border color of focused windows
...
myStartupHook = do
    ...
    spawnOnce ".config/polybar/hack/launch.sh &"
    spawnOnce "dunst &"
    setWMName "LG3D"
...
myWorkspaces = [" general ", " browse ", " chat ", "music", " code ", " term "]
...
myKeys =
    ...
    -- KB_GROUP Run Prompt
        , ("M-S-<Return>", spawn ".config/rofi/launchers/text/launcher.sh") -- Rofi
